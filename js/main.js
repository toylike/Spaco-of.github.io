...
var burger_button = document.querySelector('.burger_button');
...
var media_check = window.matchMedia("(max-width: 1490px)");
checkDropMenu(media_check);
media_check.addListener(checkDropMenu);
var burger_links = document.querySelectorAll('.burger_link');

var _iterator = _createForOfIteratorHelper(burger_links),
    _step;

try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var burger_link = _step.value;
...
function slider() {
  var slider1 = $('#reviews_slider1_js'),
      ...
      if (current_slide) {
        $(slider2).on('beforeChange', function (event, slick, currentSlide, nextSlide) {
          $(current_slide_img).attr({
            "src": "img/review".concat(nextSlide + 1, ".png")
          });
  ...
  var mediaQuery = window.matchMedia("(min-width: 1140px)");
...
module.exports = __webpack_require__(/*! D:\job_project\Spaco\src\js\/main.js */"./src/js/main.js");
